 ...
 * @since 2020-02-20
 */
public interface ProjectPraiseMapper extends com.baomidou.mybatisplus.core.mapper.BaseMapper<cn.meteor.beyondclouds.modules.project.entity.ProjectPraise> {
    /**
     * 查询点赞列表分页
     *
     * @param page
