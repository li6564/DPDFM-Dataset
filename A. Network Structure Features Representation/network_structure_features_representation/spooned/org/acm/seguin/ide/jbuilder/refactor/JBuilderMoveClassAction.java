 ...
 * @author Chris Seguin
 */
public class JBuilderMoveClassAction extends org.acm.seguin.ide.common.action.MoveClassAction {
    /**
     ...
     */
    public JBuilderMoveClassAction(com.borland.primetime.node.Node[] init) {
