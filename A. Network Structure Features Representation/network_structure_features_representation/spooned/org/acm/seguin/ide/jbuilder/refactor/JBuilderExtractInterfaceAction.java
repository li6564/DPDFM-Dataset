 ...
 * @author Chris Seguin
 */
public class JBuilderExtractInterfaceAction extends org.acm.seguin.ide.common.action.ExtractInterfaceAction {
    /**
     ...
     */
    public JBuilderExtractInterfaceAction(com.borland.primetime.node.Node[] init) {
