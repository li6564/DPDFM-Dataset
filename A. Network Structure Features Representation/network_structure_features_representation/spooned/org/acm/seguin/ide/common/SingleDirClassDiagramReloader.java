 ...
 * @author Chris Seguin
 */
public class SingleDirClassDiagramReloader extends org.acm.seguin.ide.common.ClassDiagramReloader {
    ...
    public void reload() {
        ...
        new org.acm.seguin.ide.common.SummaryLoaderThread(base).start();
        reloadDiagrams();
    }
}