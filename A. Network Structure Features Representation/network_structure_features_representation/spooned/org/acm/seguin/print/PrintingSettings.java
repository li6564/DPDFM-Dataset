...
public class PrintingSettings {
     ...
     *
     * @param value
     * 		The new HeaderBlockHeight value
     */
     ...
     *
     * @param value
     * 		The new FilenameFontSize value
     */
    ...
    public void save() {
        try {
            ...
            java.lang.String filename = (dir + java.io.File.separator) + "printing.settings";
            java.io.FileWriter output = new java.io.FileWriter(filename);
    ...
    private void init() {
        defaults();
        try {
            org.acm.seguin.util.FileSettings setting = org.acm.seguin.util.FileSettings.getSettings("Refactory", "printing");
     ...
     * 		the output writer
     */
    private void write(java.io.PrintWriter printer) {
