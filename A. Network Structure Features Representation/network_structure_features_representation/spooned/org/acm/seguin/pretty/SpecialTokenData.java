...
public class SpecialTokenData {
    ...
    private org.acm.seguin.parser.Token special;
     ...
     * 		the print data
     */
    public SpecialTokenData(org.acm.seguin.parser.Token token, org.acm.seguin.pretty.PrintData printData) {
     ...
     * 		the print data
     * @param accept
     * 		whether newlines should be accepted
     */
    public SpecialTokenData(org.acm.seguin.parser.Token token, org.acm.seguin.pretty.PrintData printData, boolean accept) {
        data = printData;
     ...
     */
    public org.acm.seguin.pretty.PrintData getPrintData() {
        return data;
    }
     ...
     * @return the special token
     */
    public org.acm.seguin.parser.Token getSpecialToken() {
        return special;
    }
     ...
     */
    public org.acm.seguin.parser.Token beginning(org.acm.seguin.parser.Token tok) {
        if (tok == null) {
            return null;
        }
