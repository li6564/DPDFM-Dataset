...
public class FieldSize {
    ...
    public java.lang.String toString() {
        return (((("Modifier:  " + modifierLength) + "    Type:  ") + typeLength) + "    Name:  ") + nameLength;
    }
}