...
public class TokenMgrError extends java.lang.Error {
    ...
    public TokenMgrError(boolean EOFSeen, int lexState, int errorLine, int errorColumn, java.lang.String errorAfter, char curChar, int reason) {
        this(org.acm.seguin.parser.TokenMgrError.LexicalError(EOFSeen, lexState, errorLine, errorColumn, errorAfter, curChar), reason);
    }
            ...
            switch (str.charAt(i)) {
                ...
                default :
                    if (((ch = str.charAt(i)) < 0x20) || (ch > 0x7e)) {
                        java.lang.String s = "0000" + java.lang.Integer.toString(ch, 16);
     ...
     * @return Description of the Returned Value
     */
    private static final java.lang.String LexicalError(boolean EOFSeen, int lexState, int errorLine, int errorColumn, java.lang.String errorAfter, char curChar) {
        return ((((((("Lexical error at line " + errorLine) + ", column ") + errorColumn) + ".  Encountered: ") + (EOFSeen ? "<EOF> " : (((("\"" + org.acm.seguin.parser.TokenMgrError.addEscapes(java.lang.String.valueOf(curChar))) + "\"") + " (") + ((int) (curChar))) + "), ")) + "after : \"") + org.acm.seguin.parser.TokenMgrError.addEscapes(errorAfter)) + "\"";
    }
}