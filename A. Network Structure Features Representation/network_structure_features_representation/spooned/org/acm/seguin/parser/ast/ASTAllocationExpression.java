 ...
 */
public class ASTAllocationExpression extends org.acm.seguin.parser.ast.SimpleNode {
    /**
     ...
     * 		Description of Parameter
     */
    public ASTAllocationExpression(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
    }
