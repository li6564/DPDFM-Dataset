 ...
 */
public class ASTNestedInterfaceDeclaration extends org.acm.seguin.parser.ast.SimpleNode implements org.acm.seguin.pretty.JavaDocable {
    // Instance Variables
     ...
     * 		Description of Parameter
     */
    public ASTNestedInterfaceDeclaration(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
        modifiers = new org.acm.seguin.pretty.ModifierHolder();
        jdi = new org.acm.seguin.pretty.JavaDocableImpl();
    }
    ...
    public boolean isRequired() {
        ...
        return jdi.isRequired() && fjc.isJavaDocRequired("class", modifiers);
    }
    ...
    public void finish() {
        ...
        org.acm.seguin.parser.ast.ASTUnmodifiedInterfaceDeclaration child = ((org.acm.seguin.parser.ast.ASTUnmodifiedInterfaceDeclaration) (jjtGetChild(0)));
        org.acm.seguin.pretty.ai.RequiredTags.getTagger().addTags(bundle, "class", child.getName(), jdi);
    }
