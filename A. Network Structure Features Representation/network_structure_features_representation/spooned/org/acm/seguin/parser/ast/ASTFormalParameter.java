 ...
 */
public class ASTFormalParameter extends org.acm.seguin.parser.ast.SimpleNode {
    // Instance Variable
     ...
     * 		Description of Parameter
     */
    public ASTFormalParameter(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
    }
     ...
     *
     * @param way
     * 		the way to set the final modifier
     */
