 ...
 */
public class ASTNestedClassDeclaration extends org.acm.seguin.parser.ast.SimpleNode implements org.acm.seguin.pretty.JavaDocable {
    // Instance Variables
     ...
     * 		Description of Parameter
     */
    public ASTNestedClassDeclaration(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
        modifiers = new org.acm.seguin.pretty.ModifierHolder();
        jdi = new org.acm.seguin.pretty.JavaDocableImpl();
    }
    ...
    public void finish() {
        ...
        org.acm.seguin.parser.ast.ASTUnmodifiedClassDeclaration child = ((org.acm.seguin.parser.ast.ASTUnmodifiedClassDeclaration) (jjtGetChild(0)));
