 ...
 */
public class ASTUnmodifiedInterfaceDeclaration extends org.acm.seguin.parser.ast.SimpleNode {
    // Instance Variable
     ...
     * 		Description of Parameter
     */
    public ASTUnmodifiedInterfaceDeclaration(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
    }
