...
class Segment {
     ...
     */
    public java.awt.Point getPoint(double t) {
        return new java.awt.Point(((int) (A0 + (t * A1))), ((int) (B0 + (t * B1))));
    }
     ...
     * 		Description of Parameter
     */
    public void reset(java.awt.Rectangle left, java.awt.Rectangle right) {
        ...
        B0 = Y0;
        B1 = Y1 - Y0;
        m = java.lang.Math.sqrt((A1 * A1) + (B1 * B1));
    }
     ...
     * 		Description of Parameter
     */
    public void reset(java.awt.Point left, java.awt.Point right) {
        double X0 = left.getX();
        double Y0 = left.getY();
     ...
     * 		Description of Parameter
     */
    public void reset(java.awt.Rectangle left, java.awt.Point right) {
        double X0 = left.getX() + (left.getWidth() * 0.5);
        double Y0 = left.getY() + (left.getHeight() * 0.5);
        double X1 = right.getX();
        double Y1 = right.getY();
     ...
     * 		Description of Parameter
     */
    public void reset(java.awt.Point left, java.awt.Rectangle right) {
        double X0 = left.getX();
        double Y0 = left.getY();
        double X1 = right.getX() + (right.getWidth() * 0.5);
        double Y1 = right.getY() + (right.getHeight() * 0.5);
    ...
    intersect
     */
    public double intersect(java.awt.Rectangle rect) {
        ...
        double leftSide = -1;
        double rightSide = -1;
        if (java.lang.Math.abs(A1) > 1.0E-4) {
            leftSide = (left - A0) / A1;
            rightSide = (right - A0) / A1;
        }
        double topSide = -1;
        double bottomSide = -1;
        if (java.lang.Math.abs(B1) > 0.001) {
            topSide = (top - B0) / B1;
     ...
     */
    public double distanceToPoint(java.awt.Point point) {
        double vX1 = A1;
        double vY1 = B1;
        ...
        double dist = java.lang.Math.sqrt(magV2Square - ((dotProduct * dotProduct) / magV1Square));
        return dist;
    }
    ...
    public double findFromEnd(double desiredDistance) {
        double p = java.lang.Math.sqrt((A1 * A1) + (B1 * B1));
     ...
     */
    public java.awt.Point aboveLine(double t, double dist) {
        if (java.lang.Math.abs(A1) < 0.001) {
            java.awt.Point temp = getPoint(t);
            return new java.awt.Point(((int) (temp.getX() - dist)), ((int) (temp.getY())));
        }
        java.awt.Point p4 = getPoint(t);
        double x4 = p4.getX();
        double y4 = p4.getY();
        double a = (B1 * B1) + (A1 * A1);
        double b = ((-2) * y4) * a;
        double c = ((y4 * y4) * a) - (((A1 * A1) * dist) * dist);
        double y5 = ((-b) + java.lang.Math.sqrt((b * b) - ((4 * a) * c))) / (2 * a);
        double x5 = (((-B1) * (y5 - y4)) / A1) + x4;
        return new java.awt.Point(((int) (x5)), ((int) (y5)));
    }
     ...
     * @return Description of the Returned Value
     */
    public java.awt.Point belowLine(double t, double dist) {
        if (java.lang.Math.abs(A1) < 0.001) {
            java.awt.Point temp = getPoint(t);
            return new java.awt.Point(((int) (temp.getX() + dist)), ((int) (temp.getY())));
        }
     ...
     *
     * @param t
     * 		the parameter that specifies the point
     * @param rect
     * 		the rectangle
     * @return true if the point is in the rectangle
     */
    private boolean inRectangle(double t, java.awt.Rectangle rect) {
        if ((t < 0) || (t > 1)) {
            return false;
        }
        double X0 = A0 + (A1 * t);
