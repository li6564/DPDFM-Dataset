 ...
 * @author Chris Seguin
 */
abstract class AddNewMethod extends org.acm.seguin.refactor.TransformAST {
    /**
     ...
     */
    public AddNewMethod(org.acm.seguin.summary.MethodSummary init) {
        methodSummary = init;
    }
    ...
    private void drillIntoType(org.acm.seguin.parser.ast.SimpleNode node) {
        if (node.jjtGetChild(0) instanceof org.acm.seguin.parser.ast.ASTClassDeclaration) {
        ...
        } else if (node.jjtGetChild(0) instanceof org.acm.seguin.parser.ast.ASTInterfaceDeclaration) {
            org.acm.seguin.parser.ast.ASTInterfaceDeclaration classDecl = ((org.acm.seguin.parser.ast.ASTInterfaceDeclaration) (node.jjtGetChild(0)));
            org.acm.seguin.parser.ast.SimpleNode unmodified = ((org.acm.seguin.parser.ast.SimpleNode) (classDecl.jjtGetChild(0)));
            org.acm.seguin.parser.ast.SimpleNode classBody = ((org.acm.seguin.parser.ast.SimpleNode) (unmodified.jjtGetChild(unmodified.jjtGetNumChildren() - 1)));
     ...
     */
    private org.acm.seguin.parser.ast.ASTMethodDeclaration build(boolean addBody) {
        org.acm.seguin.parser.ast.ASTMethodDeclaration methodDecl = new org.acm.seguin.parser.ast.ASTMethodDeclaration(0);
        // Set the modifiers
        setupModifiers(methodSummary.getModifiers(), methodDecl.getModifiers());
        // Set return type
        addReturn(methodDecl, 0);
        // Set the declaration
        org.acm.seguin.parser.ast.ASTMethodDeclarator declarator = new org.acm.seguin.parser.ast.ASTMethodDeclarator(0);
