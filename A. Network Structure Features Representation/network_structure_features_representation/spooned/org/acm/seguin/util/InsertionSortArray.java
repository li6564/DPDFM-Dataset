...
public class InsertionSortArray {
     ...
     * 		The array to sort
     * @param comparator
     * 		The object describing their relationships
     */
    public void sort(java.lang.Object[] array, org.acm.seguin.util.Comparator comparator) {
     ...
     */
    private void insert(java.lang.Object[] array, int index, org.acm.seguin.util.Comparator comparator) {
     ...
     * 		The array
     * @param index
     * 		The index of the item that needs a spot
     * @param comparator
     * 		The object that can compare the results
     * @return The index where the item should be inserted
     */
    private int findSpot(java.lang.Object[] array, int index, org.acm.seguin.util.Comparator comparator) {
     ...
     * @param location
     * 		The item's desired location
     */
    private void insertAt(java.lang.Object[] array, int index, int location) {
        // Remember the item
        java.lang.Object swap = array[index];
