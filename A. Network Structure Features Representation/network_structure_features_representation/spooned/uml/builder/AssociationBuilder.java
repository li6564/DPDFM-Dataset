 ...
 */
public class AssociationBuilder extends uml.builder.AbstractBuilder {
    /**
    ...
    /**
     */
    protected void identifyAssociations(uml.builder.Context ctx) {
        // Walk through the AssociationLinks in the model and identify all the classes
        diagram.DiagramModel model = ctx.getModel();
        for (java.util.Iterator i = new diagram.FigureIterator(model, uml.diagram.AssociationLink.class); i.hasNext();) {
            uml.diagram.AssociationLink figure = ((uml.diagram.AssociationLink) (i.next()));
     ...
     */
    protected void buildAssociation(uml.builder.Context ctx, uml.builder.MetaClass sourceClass, uml.builder.MetaClass sinkClass) {
        // Attempt to update inheritance on the meta class
        try {
            sourceClass.addAttribute(new uml.builder.MetaAssociation("private " + sinkClass.getName()));
