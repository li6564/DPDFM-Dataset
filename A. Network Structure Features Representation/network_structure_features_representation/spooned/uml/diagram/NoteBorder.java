 ...
 */
public class NoteBorder extends javax.swing.border.AbstractBorder {
     ...
     */
    public NoteBorder() {
        this(2, 6, java.awt.Color.black, true);
    }
    ...
    will be used.
     */
    public NoteBorder(int thickness, int foldThickness, java.awt.Color lineColor, boolean fillFold) {
    ...
    public java.awt.Insets getBorderInsets(java.awt.Component c) {
        return new java.awt.Insets((foldThickness + thickness) + 1, thickness, thickness, (foldThickness + thickness) + 1);
    }
    ...
    public void paintBorder(java.awt.Component c, java.awt.Graphics g, int x, int y, int w, int h) {
        ...
        g.fillRect((x + w) - ((foldThickness + thickness) + 1), (y + thickness) + foldThickness, foldThickness + 1, (y + h) - (foldThickness + thickness));
