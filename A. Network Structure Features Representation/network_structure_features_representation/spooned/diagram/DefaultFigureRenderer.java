 ...
 */
public class DefaultFigureRenderer extends javax.swing.JComponent implements diagram.FigureRenderer {
    private static final double DEFAULT_EXPANSION = 8.0;

    private static final diagram.SelectionBorder selectionBorder = new diagram.SelectionBorder();

    // Solid component to center within the transparent one
    private java.awt.Component userComponent = null;

    private diagram.Figure lastFigure = null;

    private diagram.Diagram lastDiagram = null;
     ...
     * @param Component
     */
    public DefaultFigureRenderer(java.awt.Component userComponent) {
        setLayout(null);
    ...
    public java.awt.Component getRendererComponent(Diagram diagram, Figure figure, boolean isSelected) {
        ...
        java.awt.Component component = getUserComponent();
        if (userComponent != component)
            setUserComponent(component);

        setBorder(isSelected ? DefaultFigureRenderer.selectionBorder : null);
        return this;
    }
     ...
     */
    public void setUserComponent(java.awt.Component component) {
     ...
     * Get the last Figure
     */
    public diagram.Figure getFigure() {
        return lastFigure;
    }
    ...
    public java.awt.geom.Rectangle2D getDecoratedBounds(Diagram diagram, Figure figure, java.awt.geom.Rectangle2D rcBounds) {
        ...
        rcBounds.setFrame(rcBounds.getX() - expansion, rcBounds.getY() - expansion, rcBounds.getWidth() + (2 * expansion), rcBounds.getHeight() + (2 * expansion));
        return rcBounds;
    }
    ...
    protected double getExpansion() {
        return diagram.DefaultFigureRenderer.DEFAULT_EXPANSION;
    }
