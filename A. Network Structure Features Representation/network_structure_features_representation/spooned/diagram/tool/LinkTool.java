...
public class LinkTool extends AbstractTool {
    ...
    private PointFigure ptSink = new PointFigure(LinkTool.POINT_SIZE);

    private java.awt.geom.Point2D ptCenter;

    private Link link;

    private LinkTool.MouseHandler mouseHandler = new LinkTool.MouseHandler();
