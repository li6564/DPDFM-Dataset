 ...
 */
public class SelectionTool extends diagram.tool.AbstractTool {
    private diagram.Figure[] figures = new diagram.Figure[4];

    private diagram.tool.SelectionTool.MouseHandler mouseHandler = new diagram.tool.SelectionTool.MouseHandler();
    ...
    protected class MouseHandler extends java.awt.event.MouseAdapter {
        ...
        public void mouseClicked(java.awt.event.MouseEvent e) {
            ...
            if ((e.isConsumed() || (!javax.swing.SwingUtilities.isLeftMouseButton(e))) || (e.getClickCount() > 1))
                return;
        ...
        public void mousePressed(java.awt.event.MouseEvent e) {
            ...
            if (((e.isConsumed() || e.isShiftDown()) || (!javax.swing.SwingUtilities.isLeftMouseButton(e))) || (e.getClickCount() > 1))
                return;
    ...
    private final void deselectAll(Diagram diagram, SelectionModel model, Figure except) {
        ...
        Figure[] items = ((Figure[]) (model.toArray(((java.lang.Object[]) (figures)))));
        DiagramUI ui = ((DiagramUI) (diagram.getUI()));
