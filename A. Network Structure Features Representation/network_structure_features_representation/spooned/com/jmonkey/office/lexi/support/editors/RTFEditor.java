...
/**
 */
public final class RTFEditor extends com.jmonkey.office.lexi.support.Editor implements java.awt.event.MouseListener , java.awt.event.KeyListener {
    // Public members
    /**
     * The Content type of the editor.
     */
    public static final java.lang.String CONTENT_TYPE = VALID_CONTENT_TYPES[2];

    /**
     * File Extensions this editor will handle.
     */
    public static final java.lang.String[] FILE_EXTENSIONS = new java.lang.String[]{ "rtf" };
    ...
    private com.jmonkey.office.lexi.support.editors.RTFEditor.E _EVENT_LISTENER = null;
    ...
    private final class E extends java.lang.Object implements javax.swing.event.DocumentListener , javax.swing.event.UndoableEditListener , javax.swing.event.HyperlinkListener , java.awt.event.FocusListener , java.beans.VetoableChangeListener , javax.swing.event.ChangeListener {
        private com.jmonkey.office.lexi.support.editors.RTFEditor _PARENT = null;
         ...
         */
        protected E(com.jmonkey.office.lexi.support.editors.RTFEditor parent) {
            _PARENT = parent;
        }
     ...
     * @return java.lang.String
     */
    private com.jmonkey.office.lexi.support.editors.RTFEditor.E getEventListener() {
        if (_EVENT_LISTENER == null) {
            _EVENT_LISTENER = new com.jmonkey.office.lexi.support.editors.RTFEditor.E(this);
        }
    ...
    public final java.lang.String[] getFileExtensions() {
        return com.jmonkey.office.lexi.support.editors.RTFEditor.FILE_EXTENSIONS;
    }
    ...
    public void init() {
        ...
        _EDITOR.setContentType(com.jmonkey.office.lexi.support.editors.RTFEditor.CONTENT_TYPE);// set to plain text.
