 ...
 * @see Connector
 */
public interface ConnectionFigure extends CH.ifa.draw.framework.Figure , CH.ifa.draw.framework.FigureChangeListener {
    /**
     * Sets the start Connector of the connection.
     *
     * @param figure
     * 		the start figure of the connection
     */
     ...
     *
     * @param figure
     * 		the end figure of the connection
     */
