...
public class LinkShappingTool extends AbstractTool {
    ...
    // Drag cursor
    private static final java.awt.Cursor HD_CURSOR = new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR);
    ...
    // Point first pressed
    private java.awt.geom.Point2D pressPoint;

    private LinkShappingTool.MouseHandler mouseHandler = new LinkShappingTool.MouseHandler();
    ...
    public void install(Diagram diagram) {
        if (diagram.getSelectionModel() == null)
            throw new java.lang.RuntimeException("LinkShapping requires SelectionModel support");
     ...
     */
    protected void linkPressed(PolyLink link, java.awt.event.MouseEvent event) {
    }

    /**
     * Called when a link has been clicked
     */
    protected void linkClicked(PolyLink link, java.awt.event.MouseEvent event) {
    }

    /**
     * Called when a link has been pressed
     */
    protected void linkReleased(PolyLink link, java.awt.event.MouseEvent event) {
    }
    ...
    protected class MouseHandler extends javax.swing.event.MouseInputAdapter {
        ...
        public void mouseClicked(java.awt.event.MouseEvent e) {
            ...
            if ((!e.isConsumed()) && javax.swing.SwingUtilities.isRightMouseButton(e)) {
                ...
                int point = polyLink.pointFor(pt.getX(), pt.getY(), LinkShappingTool.CLICK_TOLERANCE * 2.0);
        ...
        public void mouseDragged(java.awt.event.MouseEvent e) {
            ...
            if (pressPoint != null) {
                ...
                if (pressPoint.distance(e.getPoint()) >= LinkShappingTool.DRAG_TOLERANCE) {
                    java.awt.geom.Point2D pt = pressPoint;
                    pressPoint = null;
                    // Find the closest segment
                    int segment = polyLink.segmentFor(pt, LinkShappingTool.CLICK_TOLERANCE);
                    if (segment == (-1))
                        return;
                    ...
                    diagram.setCursor(LinkShappingTool.HD_CURSOR);
                }
            }
