 ...
 */
public class CompositeTool implements diagram.tool.Tool {
    private java.util.Vector tools = new java.util.Vector();
    ...
    public void addToolListener(diagram.tool.ToolListener l) {
        for (java.util.Iterator i = tools.iterator(); i.hasNext();)
            ((diagram.tool.Tool) (i.next())).addToolListener(l);
    ...
    public void removeToolListener(diagram.tool.ToolListener l) {
        for (java.util.Iterator i = tools.iterator(); i.hasNext();)
            ((diagram.tool.Tool) (i.next())).removeToolListener(l);
    ...
    public void add(diagram.tool.Tool tool) {
        if (!tools.contains(tool))
            tools.add(tool);

    }

    public void remove(diagram.tool.Tool tool) {
        tools.remove(tool);
    }
}