 ...
 * @version 1.0
 */
public class RectangularFigure extends java.awt.geom.Rectangle2D.Double implements java.lang.Cloneable , diagram.Figure , java.io.Serializable {
    ...
    private static int generateLocalHash() {
        java.lang.Class c = diagram.figures.RectangularFigure.class;
        return c.hashCode() + (diagram.figures.RectangularFigure.figureId++);
    }

    private static int figureId = 0;

    private int hash = diagram.figures.RectangularFigure.generateLocalHash();

    public int hashCode() {
        return diagram.figures.RectangularFigure.figureId;
    }
