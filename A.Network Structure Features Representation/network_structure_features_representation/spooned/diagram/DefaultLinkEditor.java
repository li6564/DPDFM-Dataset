 ...
 */
public class DefaultLinkEditor extends diagram.DefaultFigureEditor {
    protected diagram.DefaultLabelRenderer renderer;
     ...
     * Create a new link editor
     */
    public DefaultLinkEditor(diagram.DefaultLabelRenderer renderer) {
        super(renderer);
        this.renderer = ((diagram.DefaultLabelRenderer) (getComponent()));
    }
