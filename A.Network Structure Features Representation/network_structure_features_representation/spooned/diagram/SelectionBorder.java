 ...
 */
public class SelectionBorder extends javax.swing.border.AbstractBorder {
    ...
    public SelectionBorder() {
        this(6, java.awt.Color.lightGray);
    }
    ...
    will be used.
     */
    public SelectionBorder(int thickness, java.awt.Color lineColor) {
    ...
    public void paintBorder(java.awt.Component c, java.awt.Graphics g, int x, int y, int w, int h) {
        ...
        java.awt.Color fillColor = c.getBackground();
