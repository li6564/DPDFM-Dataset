...
@io.swagger.annotations.ApiModel(value = "BlogPraise对象", description = "")
public class BlogPraise implements java.io.Serializable {
    ...
    @io.swagger.annotations.ApiModelProperty("目标类型-1:博客，2：博客评论")
