 ...
 * @since 2020-02-20
 */
public interface QuestionPraiseMapper extends com.baomidou.mybatisplus.core.mapper.BaseMapper<cn.meteor.beyondclouds.modules.question.entity.QuestionPraise> {
    /**
     * 查询点赞列表分页
     *
     * @param page
