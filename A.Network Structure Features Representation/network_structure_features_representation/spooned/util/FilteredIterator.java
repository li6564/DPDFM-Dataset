 ...
 */
public class FilteredIterator extends util.WrappedIterator {
    private java.lang.Comparable filter;
     ...
     * @param Class
     */
    public FilteredIterator(java.util.Iterator iter, java.lang.Class filter) {
        this(iter, new util.ClassFilter(filter));
    }
     ...
     * @param Comparable
     */
    public FilteredIterator(java.util.Iterator iter, java.lang.Comparable filter) {
     ...
     * @param boolean
     */
    public FilteredIterator(java.util.Iterator iter, java.lang.Comparable filter, boolean readOnly) {
        super(iter, readOnly);
        this.filter = filter;
    }
