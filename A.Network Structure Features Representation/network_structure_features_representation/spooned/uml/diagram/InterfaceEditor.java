 ...
 * @version 1.0
 */
public class InterfaceEditor extends diagram.DefaultFigureEditor {
    protected uml.diagram.InterfaceRenderer renderer = new uml.diagram.InterfaceRenderer();

    protected uml.diagram.InterfaceComponent interfaceComponent;

    protected uml.diagram.InterfaceItem lastValue;
    ...
    public java.awt.Component getFigureEditorComponent(Diagram diagram, Figure figure, boolean isSelected) {
        ...
        lastValue = ((uml.diagram.InterfaceItem) (diagram.getModel().getValue(figure)));
        // Get the rendering component
        java.awt.Component editorComponent = renderer.getRendererComponent(diagram, figure, isSelected);
        interfaceComponent = ((uml.diagram.InterfaceComponent) (renderer.getUserComponent()));
    ...
    public java.lang.Object getCellEditorValue() {
        if (lastValue == null)
            lastValue = new uml.diagram.InterfaceItem();
