 ...
 * @version 1.0
 */
public class NoteEditor extends diagram.DefaultFigureEditor {
    private uml.diagram.NoteRenderer renderer = new uml.diagram.NoteRenderer();

    private uml.diagram.NoteComponent noteComponent;
    ...
    public java.awt.Component getFigureEditorComponent(Diagram diagram, Figure figure, boolean isSelected) {
        ...
        noteComponent = ((uml.diagram.NoteComponent) (renderer.getUserComponent()));
