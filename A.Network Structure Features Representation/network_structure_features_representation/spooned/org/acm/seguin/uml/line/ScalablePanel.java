 ...
 * @author Chris Seguin
 */
abstract class ScalablePanel extends javax.swing.JPanel {
     ...
     * 		Description of Parameter
     */
    public ScalablePanel(java.awt.LayoutManager layout, boolean doubleBuffered) {
    ...
    public void setBounds(int x, int y, int w, int h) {
        if (inShapeChange) {
            ...
            inShapeChange = true;
            super.setBounds(scaleInteger(x), scaleInteger(y), scaleInteger(h), scaleInteger(h));
            inShapeChange = false;
        }
    }
    ...
    public void setBounds(java.awt.Rectangle rect) {
        if (inShapeChange) {
            ...
            inShapeChange = true;
            super.setBounds(scaleInteger(rect.x), scaleInteger(rect.y), scaleInteger(rect.width), scaleInteger(rect.height));
            inShapeChange = false;
        }
    }
    ...
    public void scale(double value) {
        if (java.lang.Math.abs(scale - value) > 0.001) {
            java.awt.Rectangle rect = getUnscaledBounds();
            scale = value;
            inScaling = true;
            setBounds(rect);
            inScaling = false;
    ...
    public void reshape(int x, int y, int w, int h) {
        if (inShapeChange) {
            ...
            inShapeChange = true;
            super.reshape(scaleInteger(x), scaleInteger(y), scaleInteger(h), scaleInteger(h));
            inShapeChange = false;
        }
    }
    ...
    protected int scaleInteger(int value) {
        return ((int) (java.lang.Math.round(scale * value)));
    }
     ...
     */
    private java.awt.Rectangle getUnscaledBounds() {
    ...
    private int getCoordinate(int value, int absolute) {
        ...
        if ((absolute >= 0) && (java.lang.Math.abs(scaled - absolute) < 6)) {
            scaled = absolute;
        }
        return scaled;
    }
