...
public class Token {
     ...
     *  field is null.
     */
    public org.acm.seguin.parser.Token specialToken;
     ...
     * @return Description of the Returned Value
     */
    public static final org.acm.seguin.parser.Token newToken(int ofKind) {
        switch (ofKind) {
            default :
                return new org.acm.seguin.parser.Token();
        }
    }
}