 ...
 */
public class ASTPreDecrementExpression extends org.acm.seguin.parser.ast.SimpleNode {
    /**
     ...
     * 		Description of Parameter
     */
    public ASTPreDecrementExpression(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
    }
