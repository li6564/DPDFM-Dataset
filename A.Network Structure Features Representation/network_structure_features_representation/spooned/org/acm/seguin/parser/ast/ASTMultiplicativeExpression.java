 ...
 */
public class ASTMultiplicativeExpression extends org.acm.seguin.parser.ast.SimpleNode {
    // Instance Variables
     ...
     * 		Description of Parameter
     */
    public ASTMultiplicativeExpression(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
        names = new java.util.Vector();
    }
