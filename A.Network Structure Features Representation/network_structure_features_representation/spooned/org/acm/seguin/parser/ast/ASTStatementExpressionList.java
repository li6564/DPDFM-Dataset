 ...
 */
public class ASTStatementExpressionList extends org.acm.seguin.parser.ast.SimpleNode {
    /**
     ...
     * 		Description of Parameter
     */
    public ASTStatementExpressionList(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
    }
