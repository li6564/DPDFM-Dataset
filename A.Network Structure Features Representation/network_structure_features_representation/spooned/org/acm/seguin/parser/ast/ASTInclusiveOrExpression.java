 ...
 */
public class ASTInclusiveOrExpression extends org.acm.seguin.parser.ast.SimpleNode {
    /**
     ...
     * 		Description of Parameter
     */
    public ASTInclusiveOrExpression(org.acm.seguin.parser.JavaParser p, int id) {
        super(p, id);
    }
