 ...
 * @author Chris Seguin
 */
public class AttributeValueState extends org.acm.seguin.print.xml.State {
    ...
    public static org.acm.seguin.print.xml.State getState() {
        if (org.acm.seguin.print.xml.AttributeValueState.state == null) {
            org.acm.seguin.print.xml.AttributeValueState.state = new org.acm.seguin.print.xml.AttributeValueState();
        }
        return org.acm.seguin.print.xml.AttributeValueState.state;
    }
}