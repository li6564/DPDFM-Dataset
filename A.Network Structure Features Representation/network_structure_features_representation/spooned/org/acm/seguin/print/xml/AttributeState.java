 ...
 * @author Chris Seguin
 */
public class AttributeState extends org.acm.seguin.print.xml.State {
    ...
    public java.awt.Font getFont() {
        if (font == null) {
            font = new java.awt.Font("SansSerif", java.awt.Font.PLAIN, getFontSize());
        }
        return font;
    }
    ...
    protected org.acm.seguin.print.xml.State processLine(java.lang.String line, int index, java.lang.StringBuffer buf) {
        ...
        while (nextState == null) {
            ...
            if (((length != (index + 1)) && (line.charAt(index) == '=')) && (line.charAt(index + 1) == '\"')) {
                nextState = org.acm.seguin.print.xml.QuoteAttributeValueState.getState();
            } else if (line.charAt(index) == '=') {
                nextState = org.acm.seguin.print.xml.AttributeValueState.getState();
            } else if ((length != (index + 1)) && (line.charAt(index + 1) == '>')) {
    ...
    public static org.acm.seguin.print.xml.State getState() {
        if (org.acm.seguin.print.xml.AttributeState.state == null) {
            org.acm.seguin.print.xml.AttributeState.state = new org.acm.seguin.print.xml.AttributeState();
        }
        return org.acm.seguin.print.xml.AttributeState.state;
    }
}