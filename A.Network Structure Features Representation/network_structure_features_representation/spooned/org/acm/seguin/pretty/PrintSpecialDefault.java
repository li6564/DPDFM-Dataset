 ...
 * @date April 10, 1999
 */
public class PrintSpecialDefault extends org.acm.seguin.pretty.PrintSpecial {
    /**
    ...
    public boolean process(org.acm.seguin.parser.Node node, org.acm.seguin.pretty.SpecialTokenData spec) {
        java.lang.System.err.println("Unknown special token of type:  " + spec.getTokenType());
        return false;
    }
}