...
public class RefactoryInstaller {
    ...
    private static final double PRETTY_CURRENT_VERSION = 3.7;
     ...
     *
     * @param forRefactory
     * 		is true when we are installing software for a
     * 		refactory
     */
    ...
    public void run() {
        try {
            java.lang.String home = org.acm.seguin.util.FileSettings.getSettingsRoot();
            java.io.File homeDir = new java.io.File(home);
            java.lang.String dir = (home + java.io.File.separator) + ".Refactory";
            java.io.File directory = new java.io.File(dir);
            if (!directory.exists()) {
                directory.mkdirs();
            }
            java.lang.String filename = (dir + java.io.File.separator) + "pretty.settings";
            ...
            if (!file.exists()) {
                ...
                double version = 1.0;
                try {
                    java.lang.String temp = bundle.getString("indent");
                ...
                if (version < (org.acm.seguin.tools.install.RefactoryInstaller.PRETTY_CURRENT_VERSION - 0.05)) {
                    output = new java.io.FileWriter(file.getPath(), true);
                    printer = new java.io.PrintWriter(output);
            ...
            filename = (dir + java.io.File.separator) + "uml.settings";
            ...
            if (!file.exists()) {
                ...
                org.acm.seguin.util.FileSettings bundle = org.acm.seguin.util.FileSettings.getSettings("Refactory", "uml");
                bundle.setReloadNow(true);
                double version = 1.0;
                try {
                    java.lang.String temp = bundle.getString("stub.dir");
                } catch (org.acm.seguin.util.MissingSettingsException mse) {
                    version = 0.5;
                }
                try {
                ...
                if (version < (org.acm.seguin.tools.install.RefactoryInstaller.UML_CURRENT_VERSION - 0.05)) {
                    output = new java.io.FileWriter(file.getPath(), true);
                    printer = new java.io.PrintWriter(output);
            ...
            filename = (dir + java.io.File.separator) + "printing.settings";
            file = new java.io.File(filename);
            if (!file.exists()) {
                new org.acm.seguin.print.PrintingSettings().save();
            }
            filename = (dir + java.io.File.separator) + "vss.settings";
            file = new java.io.File(filename);
            if (!file.exists()) {
                output = new java.io.FileWriter(file);
                printer = new java.io.PrintWriter(output);
            ...
            filename = (dir + java.io.File.separator) + "process.settings";
            file = new java.io.File(filename);
            if (!file.exists()) {
                output = new java.io.FileWriter(file);
                printer = new java.io.PrintWriter(output);
            ...
            filename = (dir + java.io.File.separator) + "creation.txt";
            file = new java.io.File(filename);
            if (!file.exists()) {
                generateCreationText(file);
            } else {
                java.util.GregorianCalendar created = new java.util.GregorianCalendar();
                created.setTime(new java.util.Date(file.lastModified()));
                java.util.GregorianCalendar lastMonth = new java.util.GregorianCalendar();
                lastMonth.add(java.util.GregorianCalendar.MONTH, -1);
                java.io.File logFile = new java.io.File(homeDir, "log.txt");
                if ((lastMonth.after(created) && logFile.exists()) && (logFile.length() > 0)) {
                    generateCreationText(file);
                    java.lang.String message = (((((((((((("Chris Seguin wrote JRefactory to discover\n" + "how people use refactorings.  While you have\n") + "used this tool, it has created a log of which\n") + "refactorings you used.  This log contains a\n") + "number representing the refactoring and a date.\n") + "\n") + "I would really appreciate it if you could e-mail\n") + "the following file to seguin@acm.org.\n") + "\n") + org.acm.seguin.util.FileSettings.getSettingsRoot()) + java.io.File.separator) + "log.txt\n") + "\n") + "Thank you for taking the time to do this.\n";
                    javax.swing.JOptionPane.showMessageDialog(null, message, "Research request", javax.swing.JOptionPane.QUESTION_MESSAGE);
                }
            }
     ...
     */
    private void prettySettings(java.io.PrintWriter printer, double version) {
        java.lang.String username = java.lang.System.getProperty("user.name");
        org.acm.seguin.util.FileSettings bundle = null;
        try {
        ...
        if (version < (org.acm.seguin.tools.install.RefactoryInstaller.PRETTY_CURRENT_VERSION - 0.05)) {
            ...
            printer.println("version=" + org.acm.seguin.tools.install.RefactoryInstaller.PRETTY_CURRENT_VERSION);
            printer.println("");
        }
        if (version < 1.0) {
        ...
        if (version < 3.15) {
            ...
            printer.println("#  }");
            printer.println("#  ");
            java.lang.String elseLine = "false";
            try {
                if (bundle != null) {
     ...
     * 		the printer
     */
    private void vssSettings(java.io.PrintWriter printer) {
     ...
     * 		the printer
     */
    private void processSettings(java.io.PrintWriter printer) {
     ...
     * 		Description of Parameter
     */
    private void umlSettings(java.io.PrintWriter printer, double version, java.lang.String dir) {
        if (version < (org.acm.seguin.tools.install.RefactoryInstaller.UML_CURRENT_VERSION - 0.05)) {
            printer.println("");
            printer.println("#  UML File Version");
            printer.println("version=" + org.acm.seguin.tools.install.RefactoryInstaller.UML_CURRENT_VERSION);
            printer.println("");
        }
        if (version < 0.95) {
            printer.println("#  The following settings are used to set");
    ...
    private void jsdkStubInstall() {
        ...
        java.io.File outFile = new java.io.File(directory, "JDK.stub");
        if (!outFile.exists()) {
            // System.out.println("Creating:  " + outFile.getPath());
            new org.acm.seguin.tools.stub.StubPrompter(null, outFile).setVisible(true);
        }
        bundle.setContinuallyReload(false);
    }
     ...
     */
    private java.lang.String doubleBackslashes(java.lang.String value) {
     ...
     */
    private void generateCreationText(java.io.File file) throws java.io.IOException {
        java.io.FileWriter output = new java.io.FileWriter(file);
        java.io.PrintWriter printer = new java.io.PrintWriter(output);
        printer.println("Created on " + java.text.DateFormat.getDateTimeInstance().format(new java.util.Date()));
        printer.close();
        output.close();
    }
