...
/**
 */
public final class TEXTEditor extends com.jmonkey.office.lexi.support.Editor implements java.awt.event.MouseListener , java.awt.event.KeyListener {
    // Public members
    /**
     * The Content type of the editor.
     */
    public static final java.lang.String CONTENT_TYPE = VALID_CONTENT_TYPES[0];

    /**
     * File Extensions this editor will handle.
     */
    public static final java.lang.String[] FILE_EXTENSIONS = new java.lang.String[]{ "txt", "text", "*" };
    ...
    private com.jmonkey.office.lexi.support.editors.TEXTEditor.E _EVENT_LISTENER = null;
    ...
    private final class E extends java.lang.Object implements javax.swing.event.DocumentListener , javax.swing.event.UndoableEditListener , javax.swing.event.HyperlinkListener , java.awt.event.FocusListener , java.beans.VetoableChangeListener , javax.swing.event.ChangeListener {
        private com.jmonkey.office.lexi.support.editors.TEXTEditor _PARENT = null;
         ...
         */
        protected E(com.jmonkey.office.lexi.support.editors.TEXTEditor parent) {
            _PARENT = parent;
        }
    ...
    public void append(java.io.File file) throws java.io.IOException {
        com.jmonkey.office.lexi.support.EditorActionManager.threads(new com.jmonkey.office.lexi.support.editors.FRThread(file) {
            public void run() {
                ...
                try {
                    br = new java.io.BufferedReader(new java.io.FileReader(this.file));
     ...
     * @return java.lang.String
     */
    private com.jmonkey.office.lexi.support.editors.TEXTEditor.E getEventListener() {
        if (_EVENT_LISTENER == null) {
            _EVENT_LISTENER = new com.jmonkey.office.lexi.support.editors.TEXTEditor.E(this);
        }
    ...
    public final java.lang.String[] getFileExtensions() {
        return com.jmonkey.office.lexi.support.editors.TEXTEditor.FILE_EXTENSIONS;
    }
    ...
    public void hasBeenActivated(com.jmonkey.office.lexi.support.Editor editor) {
        if (editor == this) {
            com.jmonkey.office.lexi.support.EditorActionManager.enableFormatActions(false);
    ...
    public void init() {
        ...
        _EDITOR.setContentType(com.jmonkey.office.lexi.support.editors.TEXTEditor.CONTENT_TYPE);// set to plain text.
    ...
    public void insert(java.io.File file, int position) throws java.io.IOException {
        com.jmonkey.office.lexi.support.EditorActionManager.threads(new com.jmonkey.office.lexi.support.editors.FRThread(file, position) {
            public void run() {
                // ===============================
                java.io.BufferedReader br = null;
                try {
    ...
    public void write(java.io.File file) throws java.io.IOException {
        com.jmonkey.office.lexi.support.EditorActionManager.threads(new com.jmonkey.office.lexi.support.editors.FWThread(file) {
            public void run() {
                ...
                try {
                    bw = new java.io.BufferedWriter(new java.io.FileWriter(this.file));
