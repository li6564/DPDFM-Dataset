...
public final class Runtime {
     ...
     * @param directory
     * 		java.io.File the directory to ensure.
     */
    public static final java.io.File ensureDirectory(java.io.File directory) {
     ...
     */
    public static final java.awt.Color getContrastingTextColor(java.awt.Color c) {
        final double brightness = ((c.getRed() * 0.2125) + (c.getGreen() * 0.7145)) + (c.getBlue() * 0.0721);
        return brightness < 128.0 ? java.awt.Color.white : java.awt.Color.black;
    }
}